    ...
    if (!the().contains(language))
    {
        ...
        try
        {
            ...
            the()[language] = {
                ...
                { Localisation::Popup_Settings_Tabs_Appearance_FontStyle, json["popupSettingsTabsAppearanceFontStyle"].get<std::string>() },
                ...
                { Localisation::Tabs_Tablet_Orientation_Left, json["tabsTabletOrientationLeft"].get<std::string>() },
                { Localisation::Tabs_Tablet_Orientation_Right, json["tabsTabletOrientationRight"].get<std::string>() },
